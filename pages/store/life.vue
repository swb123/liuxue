...
<<<<<<< HEAD
=======
       <router-link tag="li" to="/store/advance" active-class="active"><a>能力提升</a></router-link>
       <router-link tag="li" to="/store/apartment" active-class="active"><a>留学公寓</a></router-link>
...
=======
            <div class="control-group">
                <el-select id = "inputaccount" v-model="value8" filterable placeholder="考试类型">
                <el-option
                ...
                <el-select id = "inputaccount" v-model="value9" filterable placeholder="课程类型">
                <el-option
                ...
                <el-select id = "inputaccount" v-model="value9" filterable placeholder="上课形式">
                <el-option
                    v-for="item in options1"
                    :key="item.value"
                    :label="item.label"
            ...
            <div class="control-group">
                ...
                <el-select id = "inputaccount" v-model="value8" filterable placeholder="科目">
                <el-option
                    v-for="item in options"
                    :key="item.value"
                    :label="item.label"
                ...
                <el-select id = "inputaccount" v-model="value9" filterable placeholder="学时">
                <el-option
                    v-for="item in options1"
                    :key="item.value"
                    :label="item.label"
                ...
                <el-select id = "inputaccount" v-model="value9" filterable placeholder="阶段">
                <el-option
                    v-for="item in options1"
                    :key="item.value"
                    :label="item.label"
     ...
     <ul class="activity"> 
      <li class="activity-item"> 
       <div class="activity-inner"> 
        ...
        <div class="text"> 
         <p class="title">考试指导</p> 
         <div class="fl goin"> 
          <p>价格：300</p> 
         </div> 
         <div class="fr btn"> 
          <span class="sui-btn btn-bao">加入购物车</span> 
         </div> 
...
export default {
    ...
    asyncData(){
      return  clientAPI.searchItems(3,1,12,{state:'1'}).then( res => {
    ...
    methods: {
      loadMore(){
        this.pageNo++
        clientAPI.searchItems(3,this.pageNo,12,{state:'1'}).then( res => {
